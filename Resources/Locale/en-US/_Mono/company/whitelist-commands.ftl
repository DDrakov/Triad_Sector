...
command-description-faction-playercompanies = Gets all the factions that a player has been whitelisted for.
cmd-company-playercompanies-whitelisted-for = Player {$player} is whitelisted for:
{$companies}

command-description-faction-members = Gets all the players that has been whitelisted for a player faction.
cmd-company-members-whitelisted-for = Company {$company} is whitelisted for:
    {$players}
    {$company} owners:
    {$owners}

command-description-faction-setowner = Set owner status of a player in a player faction. Note: Add member to the faction before this command!
cmd-company-setowner-success = Successfully changed owner status of {$player} to {$status}

command-description-faction-removemember = Removes a player's ability to play a whitelisted player faction.
